...
export default function Board () {
  ...
  return (
    <div>
      ...
      >
        <h1 className="text-6xl pt-20 text-center text-slate-200 font-bold">Tarot Reading</h1>
        ...
        <div className='pb-10 flex flex-row gap-10'>
          <button
            onClick={refresh}
            className='border-2 rounded-2xl border-slate-700 p-4 text-slate-200 font-bold'
          >
            New Cards
          </button>
          <button
